...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/8a46f718' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_mean_corrected_preprocessed_no_image_pca.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
