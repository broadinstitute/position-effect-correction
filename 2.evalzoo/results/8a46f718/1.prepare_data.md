...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/3.correct/output/subset_profiles_mean_corrected_preprocessed_no_image_pca.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/8a46f718/profiles.parquet
...
| tag | filename                                                                                                           |
| :-- | :----------------------------------------------------------------------------------------------------------------- |
|     | ../../position-effect-correction/3.correct/output/subset_profiles_mean_corrected_preprocessed_no_image_pca.parquet |
