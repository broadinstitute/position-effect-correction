...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/1.load/output/processed_profiles.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/c2da86bd/profiles.parquet
...
| tag | filename                                                                  |
|:----|:--------------------------------------------------------------------------|
|     | ../../position-effect-correction/1.load/output/processed_profiles.parquet |
