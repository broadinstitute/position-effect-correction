...
```
    ...
    ## output_index_file: ../../position-effect-correction/2.evalzoo/results/125bfb5b/index.parquet
    ## output_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/125bfb5b/collatedindex.parquet
    ## sim_params:
    ##   drop_group:
