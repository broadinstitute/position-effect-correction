...
```
    ...
    ## output_index_file: ../../position-effect-correction/2.evalzoo/results/34fbd8a4/index.parquet
    ## output_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/34fbd8a4/collatedindex.parquet
    ## sim_params:
    ##   drop_group:
