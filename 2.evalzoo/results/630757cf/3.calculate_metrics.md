...
```
    ...
    ## input_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/630757cf/collatedindex.parquet
    ## output_collatedsim_file: ../../position-effect-correction/2.evalzoo/results/630757cf/collatedsim.parquet
    ## output_metrics_file_prefix: ../../position-effect-correction/2.evalzoo/results/630757cf/metrics
