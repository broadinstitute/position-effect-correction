...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/ac65bc4b' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_processed_profiles_no_image_pca.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
