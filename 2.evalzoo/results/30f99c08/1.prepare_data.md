...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/3.correct/output/subset_profiles_cc_corrected_cospca_20.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/30f99c08/profiles.parquet
...
| tag | filename                                                                                         |
| :-- | :----------------------------------------------------------------------------------------------- |
|     | ../../position-effect-correction/3.correct/output/subset_profiles_cc_corrected_cospca_20.parquet |
