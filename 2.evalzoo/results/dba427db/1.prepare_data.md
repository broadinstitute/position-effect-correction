...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/3.correct/output/subset_profiles_mean_corrected.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/dba427db/profiles.parquet
...
| tag | filename                                                                                 |
|:----|:-----------------------------------------------------------------------------------------|
|     | ../../position-effect-correction/3.correct/output/subset_profiles_mean_corrected.parquet |
