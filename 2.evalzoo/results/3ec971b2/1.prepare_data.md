...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/3.correct/output/full_profiles_mean_corrected_preprocessed_subset.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/3ec971b2/profiles.parquet
...
| tag | filename                                                                                                   |
|:----|:-----------------------------------------------------------------------------------------------------------|
|     | ../../position-effect-correction/3.correct/output/full_profiles_mean_corrected_preprocessed_subset.parquet |
