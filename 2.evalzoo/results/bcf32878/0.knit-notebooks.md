...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/bcf32878' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_processed_profiles_cospca_20.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
