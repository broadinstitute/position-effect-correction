...
```
    ...
    ## output_index_file: ../../position-effect-correction/2.evalzoo/results/d2311b58/index.parquet
    ## output_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/d2311b58/collatedindex.parquet
    ## sim_params:
    ##   drop_group:
