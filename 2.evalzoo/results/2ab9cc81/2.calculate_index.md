...
```
    ...
    ## input_profile_file: ../../position-effect-correction/2.evalzoo/results/2ab9cc81/profiles.parquet
    ## output_index_file: ../../position-effect-correction/2.evalzoo/results/2ab9cc81/index.parquet
    ## output_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/2ab9cc81/collatedindex.parquet
    ## sim_params:
    ##   drop_group:
