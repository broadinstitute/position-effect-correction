...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/1.load/output/full_processed_profiles.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/2ab9cc81/profiles.parquet
...
| tag | filename                                                                       |
|:----|:-------------------------------------------------------------------------------|
|     | ../../position-effect-correction/1.load/output/full_processed_profiles.parquet |
