...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/1.load/output/subset_processed_profiles_cospca_30.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/f86c9fcc/profiles.parquet
...
| tag | filename                                                                                   |
| :-- | :----------------------------------------------------------------------------------------- |
|     | ../../position-effect-correction/1.load/output/subset_processed_profiles_cospca_30.parquet |
