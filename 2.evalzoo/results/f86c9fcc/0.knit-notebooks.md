...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/f86c9fcc' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_processed_profiles_cospca_30.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
