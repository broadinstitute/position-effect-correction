...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/3.correct/output/subset_processed_cc_corrected.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/a69994b0/profiles.parquet
...
| tag | filename                                                                                |
|:----|:----------------------------------------------------------------------------------------|
|     | ../../position-effect-correction/3.correct/output/subset_processed_cc_corrected.parquet |
