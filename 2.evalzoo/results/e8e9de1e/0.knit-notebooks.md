...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/e8e9de1e' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_cc_well_corrected_pca.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
