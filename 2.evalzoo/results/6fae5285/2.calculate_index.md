...
```
    ...
    ## output_index_file: ../../position-effect-correction/2.evalzoo/results/6fae5285/index.parquet
    ## output_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/6fae5285/collatedindex.parquet
    ## sim_params:
    ##   drop_group:
