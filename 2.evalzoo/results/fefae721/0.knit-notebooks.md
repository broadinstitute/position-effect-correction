...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/fefae721' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_cc_well_corrected_cospca_30.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
