...
```
    ...
    ## input_profile_file: ../../position-effect-correction/2.evalzoo/results/adacbee3/profiles.parquet
    ## input_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/adacbee3/collatedindex.parquet
    ## output_collatedsim_file: ../../position-effect-correction/2.evalzoo/results/adacbee3/collatedsim.parquet
    ## output_metrics_file_prefix: ../../position-effect-correction/2.evalzoo/results/adacbee3/metrics
