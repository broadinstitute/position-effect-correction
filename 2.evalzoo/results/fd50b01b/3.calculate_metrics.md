...
```
    ...
    ## input_profile_file: ../../position-effect-correction/2.evalzoo/results/fd50b01b/profiles.parquet
    ## input_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/fd50b01b/collatedindex.parquet
    ## output_collatedsim_file: ../../position-effect-correction/2.evalzoo/results/fd50b01b/collatedsim.parquet
    ## output_metrics_file_prefix: ../../position-effect-correction/2.evalzoo/results/fd50b01b/metrics
