...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/3d645cb2' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_cc_corrected_pca.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
