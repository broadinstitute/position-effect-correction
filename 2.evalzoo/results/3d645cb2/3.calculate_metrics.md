...
```
    ...
    ## input_profile_file: ../../position-effect-correction/2.evalzoo/results/3d645cb2/profiles.parquet
    ## input_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/3d645cb2/collatedindex.parquet
    ## output_collatedsim_file: ../../position-effect-correction/2.evalzoo/results/3d645cb2/collatedsim.parquet
    ## output_metrics_file_prefix: ../../position-effect-correction/2.evalzoo/results/3d645cb2/metrics
