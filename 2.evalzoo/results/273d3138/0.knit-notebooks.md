...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/273d3138' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_processed_profiles_cospca.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
