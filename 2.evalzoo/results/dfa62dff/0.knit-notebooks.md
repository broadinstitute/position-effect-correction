...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/dfa62dff' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_cc_corrected_cospca.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
