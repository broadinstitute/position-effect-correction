...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/21b92180' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_cc_well_corrected_no_image_pca.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
