...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/306333dc' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_mean_corrected_preprocessed_no_image.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
...
```
    ...
    ## Warning: ggrepel: 2901 unlabeled data points (too many overlaps). Consider increasing max.overlaps
