...
```
    ...
    ## input_profile_file: ../../position-effect-correction/2.evalzoo/results/cdaf16db/profiles.parquet
    ## input_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/cdaf16db/collatedindex.parquet
    ## output_collatedsim_file: ../../position-effect-correction/2.evalzoo/results/cdaf16db/collatedsim.parquet
    ## output_metrics_file_prefix: ../../position-effect-correction/2.evalzoo/results/cdaf16db/metrics
