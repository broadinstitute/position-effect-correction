...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/cdaf16db' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_mean_corrected_preprocessed_cospca_30.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
