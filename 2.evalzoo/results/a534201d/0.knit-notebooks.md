...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/a534201d' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_mean_corrected_preprocessed_cospca.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
