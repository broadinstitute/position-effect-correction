...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/3.correct/output/subset_profiles_cc_corrected_no_image.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/d4df76cd/profiles.parquet
...
| tag | filename                                                                                        |
| :-- | :---------------------------------------------------------------------------------------------- |
|     | ../../position-effect-correction/3.correct/output/subset_profiles_cc_corrected_no_image.parquet |
