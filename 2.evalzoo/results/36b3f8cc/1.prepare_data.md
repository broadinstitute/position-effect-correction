...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/1.load/output/subset_profiles.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/36b3f8cc/profiles.parquet
...
| tag | filename                                                               |
|:----|:-----------------------------------------------------------------------|
|     | ../../position-effect-correction/1.load/output/subset_profiles.parquet |
