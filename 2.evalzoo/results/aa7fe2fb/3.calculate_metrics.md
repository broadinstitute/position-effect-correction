...
```
    ...
    ## input_profile_file: ./results/aa7fe2fb/profiles.parquet
    ## input_collatedindex_file: ./results/aa7fe2fb/collatedindex.parquet
    ## output_collatedsim_file: ./results/aa7fe2fb/collatedsim.parquet
    ## output_metrics_file_prefix: ./results/aa7fe2fb/metrics
