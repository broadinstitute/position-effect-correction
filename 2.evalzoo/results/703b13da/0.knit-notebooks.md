...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): '../../position-effect-correction/2.evalzoo/results/703b13da' already exists
...
```
    ...
    ##   input_structure: '{data_path}/subset_profiles_mean_corrected_preprocessed_cospca_20.{extension}'
    ##   extension: parquet
    ##   external_metadata: ~
