...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/3.correct/output/subset_profiles_mean_corrected_preprocessed_cospca_20.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/703b13da/profiles.parquet
...
| tag | filename                                                                                                        |
| :-- | :-------------------------------------------------------------------------------------------------------------- |
|     | ../../position-effect-correction/3.correct/output/subset_profiles_mean_corrected_preprocessed_cospca_20.parquet |
