...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: ../../position-effect-correction/1.load/output/subset_processed_profiles_pca.parquet
    ## output_profile_file: ../../position-effect-correction/2.evalzoo/results/10792e71/profiles.parquet
...
| tag | filename                                                                             |
|:----|:-------------------------------------------------------------------------------------|
|     | ../../position-effect-correction/1.load/output/subset_processed_profiles_pca.parquet |
