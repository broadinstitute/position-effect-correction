...
```
    ...
    ## output_index_file: ../../position-effect-correction/2.evalzoo/results/cd1b92de/index.parquet
    ## output_collatedindex_file: ../../position-effect-correction/2.evalzoo/results/cd1b92de/collatedindex.parquet
    ## sim_params:
    ##   drop_group:
